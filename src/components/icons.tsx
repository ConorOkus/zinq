...
/** Receive arrow (bottom-left diagonal) */
export function ArrowDownLeft({ className = 'w-6 h-6' }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
/** Right-pointing arrow (next / forward) */
...
/** Left-pointing arrow (back / chevron) */
export function ChevronBack({ className = 'w-6 h-6' }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
/** X / close icon */
export function XClose({ className = 'w-6 h-6' }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
/** Backspace / delete key icon */
export function BackspaceIcon({ className = 'w-7 h-7' }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
